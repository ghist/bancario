...
class Tela_Deposito(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(260, 90, 101, 21))
        font = QtGui.QFont()
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(280, 230, 75, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "VALOR"))
